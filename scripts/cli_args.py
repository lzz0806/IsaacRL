...
def add_rsl_rl_args(parser: argparse.ArgumentParser):
    ...
    arg_group = parser.add_argument_group("rsl_rl", description="Arguments for RSL-RL agents.")
...
def parse_rsl_rl_cfg(task_name: str, args_cli: argparse.Namespace) -> RslRlOnPolicyRunnerCfg:
    """Parse configuration for RSL-RL agents based on inputs.
    ...
    Returns:
        The parsed configuration for RSL-RL agents based on inputs.
    """
